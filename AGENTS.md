...
**FINDINGS.md** — what's been discovered (newest first, Codex's session brief)
**WS1-discovery/CONTEXT.md** — the interpretation frame (signals, not root causes)

## Commands
```bash
bash ~/.Codex/skills/linear/scripts/linear.sh project "JIO CX"   # sprint board
...
| WS1-discovery/         | Skills run here. Reports land in .Codex/reports/. FINDINGS.md feeds here. |
